...
export class BarChartComponent implements AfterViewInit, OnDestroy {
  ...
  /** Bar color - override this in child classes to customize */
  protected barColor: string = '#5470C6';
  ...
  protected renderChart(chartData?: { category: string[]; value: number[] }): void {
    if (!this.data) return;
