...
export class SideNavbarComponent {
  ...
  constructor(
    ...
    this.logo = this.environment?.COMPANY_LOGO_SRC;
    this.companyText = this.environment?.COMPANY_LOGO_TEXT;
    this.router.events
  ...
  goToHelp() {
    const helpUrl = this.environment?.HELP_URL || 'https://default.help.com';
    window.open(helpUrl, '_blank');
  }

  goToFeedback() {
    const feedbackUrl = this.environment?.FEEDBACK_URL;
